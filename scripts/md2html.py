...
# -*- coding: utf-8 -*-
"""
md2html.py — 把艾利特 SEO/GEO 文章 Markdown 转成官网 CMS 富文本 HTML

官网 CMS（cms.jiasou.cn）的富文本编辑器只吃 HTML，直接粘 Markdown 会显示成纯文本。
本脚本把写作产出的 Markdown 正文转成语义化 HTML，结构与线上文章一致：
